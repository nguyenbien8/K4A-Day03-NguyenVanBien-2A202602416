...
class MCPAcademicServer:
    """
    Giả lập MCP Server Vinmec tuân thủ chuẩn giao thức Model Context Protocol
    """
...
if __name__ == "__main__":
    ...
    if sched_tool and not sched_tool.get("parameters", {}).get("properties"):
        print("⏳ [TASK 1.2]: Tool 'book_appointment' chưa được định nghĩa properties trong 'src/tools.py'.")
    else:
        print("✅ [TASK 1.2]: Tool 'book_appointment' đã có schema đầy đủ.")
    ...
    if not test_result:
        ...
        print("✅ [TASK 2.1]: Test dispatch tool 'doctor_schedule_query' thành công:")
